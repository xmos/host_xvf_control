...
enum cmd_param_type_t {TYPE_CHAR, TYPE_UINT8, TYPE_INT32, TYPE_UINT32, TYPE_FLOAT}; // TYPE_CHAR can only be CMD_RO
union cmd_param_t {uint8_t ui8; int32_t i32; uint32_t ui32; float f;};
