...
opt_t options[] = {
    ...
    {"--get-equalization-filter", "-ge",       "get equalization filter into .bin file, default is eq_buffer.bin"                               },
    {"--set-equalization-filter", "-se",       "set equalization filter from .bin file, default is eq_buffer.bin"                               },
